    ...
    if safe.get("period_ended"):
        ...
        return {
            ...
            "reason": (
                ...
                "SignalSpace shows money available now."
            ),
            "month": month,
            "amount": 0.0,
            "weekly_amount": 0.0,
...
def recommended_actions(conn: Optional[sqlite3.Connection] = None,
    ...
    if (not sts.get("available")
        ...
        _add({
            ...
            "why": "Safe to Spend stays unavailable until SignalSpace knows the cash and card balances you have now.",
            "page": "Insights",
            "label": "Open Insights",
        })
...
def _verdict(freshness: dict, sts: dict, progress: dict,
    ...
    if freshness.get("state") == "no_data":
        return {
            ...
            "sentence": "Import your first statement and SignalSpace will take "
                        "it from there.",
        }
