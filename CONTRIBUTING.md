...
3. Keep AI features read-only. AI may explain deterministic packets but must not
...
- [ ] Any AI-facing change explains which deterministic evidence packet it uses.
- [ ] User-facing copy is practical and not financial advice.

## AI-Assisted Development

AI coding tools are welcome here, but the rules are the same as for human
contributors:
...
- never let AI mutate financial data.
