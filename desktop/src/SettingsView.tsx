  ...
  return (
    <section className="workflow-panel">
      ...
      <details className="chart-card settings-collapse"
        ...
        <p className="guidance">Northstar's historical planning average includes genuine income unless you exclude it. Payroll can appear as an expected payday automatically. Use as income confirms another regular source for the Radar; Exclude removes it from planning.</p>
