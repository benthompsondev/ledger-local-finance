...
/**
 * Checking for updates is the one thing in SignalSpace that reaches the
  ...
  return (
    <article className="form-card" id="app-updates">
      ...
      <p className="guidance">
        SignalSpace checks GitHub only when you press the button below, and only
      ...
      <dl>
        <div><dt>Installed</dt><dd>SignalSpace {version || "…"}</dd></div>
      </dl>
      ...
      <p className="file-meta">
        Updates are signed. SignalSpace installs one only if the signature
